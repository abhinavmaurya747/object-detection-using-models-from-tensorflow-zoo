...
def visualize_boxes_and_labels_on_image_array(
  ...
  import pandas as pd
  box_antonations_data = []
  colors=[]
  for box, color in box_to_color_map.items():
    a,b,c,d = box
    box_antonations_data.append([a,b,c,d])
    colors.append(color)
  box_antonations_data = pd.DataFrame(np.array(box_antonations_data), index=colors)
  box_antonations_data.to_csv("./cache/anto.csv")
